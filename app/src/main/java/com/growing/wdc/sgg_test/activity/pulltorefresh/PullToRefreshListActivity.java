...
public final class PullToRefreshListActivity extends ListActivity {
    ...
    private static final int LOADOK = 123456;
    private static final int LOADMORE = 654321;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPullRefreshListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
                //设置算法 计算刷新时间，并设置到 header中
                String label = DateUtils.formatDateTime(getApplicationContext(), System.currentTimeMillis(),
                        DateUtils.FORMAT_SHOW_TIME | DateUtils.FORMAT_SHOW_DATE | DateUtils.FORMAT_ABBREV_ALL);

                // Update the LastUpdatedLabel
//                refreshView.getLoadingLayoutProxy().setLastUpdatedLabel(label);
//                refreshView.getLoadingLayoutProxy().setReleaseLabel("bbb");
//                refreshView.getLoadingLayoutProxy().setRefreshingLabel("aaaa");
//                refreshView.getLoadingLayoutProxy().setPullLabel("ccc");
...
//        mPullRefreshListView.setRefreshing();
    ...
    private Handler muiHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case LOADOK:
//                    if (mPullRefreshListView.getMode() == Mode.PULL_FROM_END) {//判断是下拉加载更多
//                        mListItems.addLast("Added after pull...");
//                    } else {
...
//                        mListItems.addLast("Added after pull...");
//                    } else {
                    mListItems.addLast("Added after more...");
//                    }
